...
class WGAN():
    ...
    , using_generator = False):
        ...
        for epoch in range(initial_epoch, initial_epoch + epochs):
            ...
            # Plot the progress
            print ("%d (%d, %d) [D loss: (%.1f, %.1f, %.1f)] [D acc: (%.3f, %.3f, %.3f)] [G loss: %.1f] [G acc: %.3f]" % (epoch, d_counter, g_counter, d_loss[0], d_loss[1], d_loss[2], d_acc[0], d_acc[1], d_acc[2], g_loss, g_acc))
